...
def load_data_from_dirs(directories, target_size=(224, 224)):
    data = []
    labels = []
...
class_weights = {0: 1.0, 1: 5.0, 2: 1.0}  # Adjust these values based on your dataset

# Train models with 'class_weight'
history1 = model1.fit(
    train_data,
    train_labels,
...
def evaluate_model(true_labels, predicted_labels, model_name):
    ...
    print(
        f"Classification Report:{classification_report(true_labels, predicted_labels)}"
    )
